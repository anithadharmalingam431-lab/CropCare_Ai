...
Maps each model class index to crop, disease, status, description,
symptoms, and recommended treatment/prevention steps.
"""
...
DISEASE_INFO = {
    "Healthy": {
        ...
        "description": (
            ...
            "The tissue shows uniform coloration and no lesions, spots, or fungal growth."
        ),
        "symptoms": [
            "No visible lesions or discoloration",
            "Uniform green coloration",
            "No fungal growth or mold present",
        ],
        "recommendation": [
    ...
    "Early Blight": {
        ...
        "status": "Diseased",
        "description": (
            "Early blight is a fungal disease caused by Alternaria solani that affects "
            "tomato and potato plants. It typically appears on older leaves first and "
            "can significantly reduce yield if left untreated."
        ),
        "symptoms": [
    ...
    "Late Blight": {
        ...
        "description": (
            ...
            "It spreads rapidly in cool, wet weather and can destroy an entire crop "
            "within days if conditions are favorable."
        ),
        "symptoms": [
    ...
    "Leaf Spot": {
        ...
        "status": "Diseased",
        "description": (
            "Leaf spot is a common fungal or bacterial disease that causes spots on "
            "leaves. It can be caused by various pathogens including Septoria, "
            "Cercospora, and bacterial species. Severe infections can lead to "
    ...
    "Rust": {
        ...
        "status": "Diseased",
        "description": (
            "Rust is a fungal disease caused by various rust fungi (Puccinia spp.). "
            "It produces characteristic rust-colored pustules on leaves and stems, "
            "reducing plant vigor and yield."
        ),
        "symptoms": [
    ...
    "Powdery Mildew": {
        ...
        "status": "Diseased",
        "description": (
            "Powdery mildew is a fungal disease that creates a white or gray powdery "
            "coating on leaf surfaces. It thrives in warm, dry conditions with high "
            "humidity and can affect a wide range of crops."
        ),
        "symptoms": [
...
def get_disease_info(class_name: str) -> dict:
    """Return disease metadata for a given class name."""
